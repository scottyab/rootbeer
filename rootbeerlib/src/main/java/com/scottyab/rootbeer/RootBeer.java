...
public class RootBeer {
    ...
    public RootBeer(Context context) {
        mContext = context;
        hookDetection = new HookDetection(context);
    }
    ...
    public boolean isRooted() {
        ...
        // Test for method hooking if enabled
        // TODO: Not sure if we need to put the hookDetection.checkForHooking() in other methods too...
        // If not, remove and make method static?
        hookDetection.checkForHooking();
        ...
        return detectRootManagementApps() ||
                ...
                checkSuExists() ||
                checkForRootNative() ||
                hookDetection.wasHookingDetected() ||
                hookDetection.detectIncorrectlyNativeMethods() ||
                hookDetection.detectSuspiciousLoadedSharedObjectsOrJars();
    }
    ...
    /**
     * @param enabled - set to false to disable hook checking
     */
    public void setHookingDetection(boolean enabled) {
        hookDetection.setEnabled(enabled);
    }
